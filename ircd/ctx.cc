...
double ircd::ctx::prof::settings::stack_usage_warning = 0.33;
...
double ircd::ctx::prof::settings::stack_usage_assertion = 0.5;
...
ulong ircd::ctx::prof::settings::slice_warning = 280 * 1000000L;
...
ulong ircd::ctx::prof::settings::slice_interrupt = 0L;
...
ulong ircd::ctx::prof::settings::slice_assertion = 0L;
...
noexcept
{
	...
	const double stack_usage_assertion = ircd::ctx::prof::settings::stack_usage_assertion;
	return stack_usage_assertion > 0.0?
		stack_at >= c.stack.max * ircd::ctx::prof::settings::stack_usage_assertion:
		false;
}
...
noexcept
{
	switch(st.st)
	{
		...
		default: switch(state_)
		{
			...
			case future_state::PENDING:
				return uintptr_t(st.p) >= 4U * 1024U;
